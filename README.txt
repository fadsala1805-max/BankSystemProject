...
Originally everything lived in one file that just printed results directly. Now the account methods return a result instead of printing, so the logic can be tested completely on its own, without needing to simulate typing into a menu.
